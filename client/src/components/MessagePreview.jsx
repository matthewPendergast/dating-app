...
const MessagePreview = ({
    ...
    return (
        <div className={`flex flex-shrink-0 h-[6rem] border-gray-400 border-[1px] shadow-[inset_-1px_-1px_7px_1px] hover:bg-gray-200 active:shadow-[inset_-1px_-1px_9px_1px] cursor-pointer ${className}`}
            onClick={onClick}>
